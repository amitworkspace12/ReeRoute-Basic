...
const Group = () => {
  return (
    <div className='flex items-center  my-10 text-[#2A4F6D] w-full flex-col lg:flex-row lg:justify-around'>
      ...
      <div className='flex items-center justify-center'>
        <div className=' font-bold px-1 lg:text-2xl font-Kurb'>70+</div>
        <div className='w-3 h-3 bg-orange-400 px-1'></div>
